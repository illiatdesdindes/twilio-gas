...
var UsageRecords_ = function (client, accountSid) {
    ...
    function Records(id) {
        ...
        generate_.restFunctions(resourceApi,client,['GET'], baseResourceUrl + '/' + id);
    ...
    //List requests
    generate_.restFunctions(Records, client, ['GET'], baseResourceUrl);
